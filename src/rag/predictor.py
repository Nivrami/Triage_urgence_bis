...
class MLTriagePredictor:
    ...
    def predict(self, chatbot_summary: Dict) -> Dict:
        ...
        result = {
            ...
            "features_used": {
                "FC": features[0], "FR": features[1], "SpO2": features[2],
                "TA_sys": features[3], "TA_dia": features[4], "Temp": features[5],
                "Age": features[6], "Sex": "H" if features[7] == 1 else "F"
            },
    ...
    def _clean_rag_context(self, context: str, severity: str) -> str:
        ...
        for line in lines:
            ...
            if len(line) > 20 or line.startswith('-') or line.startswith('✅') or line.startswith('•'):
    ...
    def _justify(self, severity: str, flags: List[str], features: List[float], symptoms: List[str], rag: Dict) -> str:
        """Justification."""
